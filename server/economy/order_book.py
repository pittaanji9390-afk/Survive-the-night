...
Module: order_book
Description: High-Frequency Limit Order Book, Market Depth & FIFO Matching Engine
...
class OrderBook:
    """
    Production-grade implementation of High-Frequency Limit Order Book, Market Depth & FIFO Matching Engine.
    """
    def __init__(self, config: Optional[OrderBookConfig] = None) -> None:
        ...
        self._history_log: List[OrderBookStateSnapshot] = []
        self._subscribers: List[Callable[[OrderBookStateSnapshot], None]] = []
    ...
    def tick(self, delta_time: float) -> OrderBookStateSnapshot:
    ...
    def subscribe(self, callback: Callable[[OrderBookStateSnapshot], None]) -> None:
        if callback not in self._subscribers:
            self._subscribers.append(callback)

    def unsubscribe(self, callback: Callable[[OrderBookStateSnapshot], None]) -> None:
...
def create_instance(config: Optional[OrderBookConfig] = None) -> OrderBook:
